...
Solver.ControlEquation.Pairwise.Acceleration.ContainerSize = 3
...
Preprocess.Microstructure.geometry_layer_0.polyhedron =  {[(16,16,1)],[(32.5,0,0),(32.5,1,0),(32.5,0,1)],[(0,0,0)]}
Preprocess.Microstructure.geometry_layer_0.phi = 1.0
Preprocess.Microstructure.geometry_layer_0.is_normalized = true
Preprocess.Microstructure.geometry_layer_1.property = (2,2,1,false)
Preprocess.Microstructure.geometry_layer_1.polyhedron =  {[(32,48,1)],[(0,32.5,0),(1,32.5,0),(0,32.5,1)],[(0,0,0)]}
Preprocess.Microstructure.geometry_layer_1.phi = 1.0
...
Solver.ControlEquation.PhaseField.VTS.grains = true
