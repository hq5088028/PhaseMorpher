...
namespace pf {
	namespace pair_wise_functions {
		// -
		phi_parameters::pair_wise_equation::Flag currentFlag(int x, int y, int z, PhaseFieldPoint& point, phi_parameters::pair_wise_equation::PairwisePoint& point_ex, int phi_index);
		// - 
		...
		// - crack resistence
		REAL Gc_acc(PhaseFieldPoint& point, phi_parameters::pair_wise_equation::PairwisePoint& point_ex);
		REAL dGc_dphi_acc(PhaseFieldPoint& point, phi_parameters::pair_wise_equation::PairwisePoint& point_ex, int phi_index);
		// - interface energy model
		REAL dfint_dphi_grad_S1996_acc(PhaseFieldPoint& point, phi_parameters::pair_wise_equation::PairwisePoint& point_ex, int phi_index);
		REAL dfint_dphi_grad_S1999_acc(PhaseFieldPoint& point, phi_parameters::pair_wise_equation::PairwisePoint& point_ex, int phi_index);
		REAL dfint_dphi_pot_Nobstacle_acc(PhaseFieldPoint& point, phi_parameters::pair_wise_equation::PairwisePoint& point_ex, int phi_index);
		REAL dfint_dphi_pot_Nwell_acc(PhaseFieldPoint& point, phi_parameters::pair_wise_equation::PairwisePoint& point_ex, int phi_index);
		REAL dfint_dphi_solid_D2016_acc(PhaseFieldPoint& point, phi_parameters::pair_wise_equation::PairwisePoint& point_ex, int phi_index);
		REAL dfint_dphi_crack_D2016_acc(int x, int y, int z, PhaseFieldPoint& point, int phi_index);
		void pairwise_normalize_daniel_crack_acc(PhaseFieldPoint& point, phi_parameters::pair_wise_equation::PairwisePoint& point_ex);
		REAL dfint_dphi_pairwise_acc(int x, int y, int z, PhaseFieldPoint& point, phi_parameters::pair_wise_equation::PairwisePoint& point_ex, int phi_index);
		void pairwise_normalize_normal(pf::PhaseFieldPoint& point, pf::phi_parameters::pair_wise_equation::PairwisePoint& point_ex);
		REAL dfint_dphi_S2009(PhaseFieldPoint& point, int phi_alpha_index, int phi_beta_index);
		REAL dfbulk_dphi_pairwise_acc(PhaseFieldPoint& point, phi_parameters::pair_wise_equation::PairwisePoint& point_ex, int phi_index);
		REAL source_pairwise_acc(PhaseFieldPoint& point, phi_parameters::pair_wise_equation::PairwisePoint& point_ex, int phi_alpha_index, int phi_beta_index);
		...
		inline void init_pairwise_equation() {
			InputFileReader::get_instance()->read_int_value("Solver.ControlEquation.Pairwise.Acceleration.ContainerSize", phi_parameters::pair_wise_equation::phi_acc_number, true);
			phi_parameters::pair_wise_equation::phase_field_pairwise.init(mesh_parameters::MESH_NX, mesh_parameters::MESH_NY, mesh_parameters::MESH_NZ);
			phi_parameters::pair_wise_equation::phase_field_Gc.init(mesh_parameters::MESH_NX, mesh_parameters::MESH_NY, mesh_parameters::MESH_NZ);
			for (int x = 0; x < phi_parameters::pair_wise_equation::phase_field_pairwise.Nx(); x++)
				for (int y = 0; y < phi_parameters::pair_wise_equation::phase_field_pairwise.Ny(); y++)
					for (int z = 0; z < phi_parameters::pair_wise_equation::phase_field_pairwise.Nz(); z++) {
						phi_parameters::pair_wise_equation::phase_field_pairwise(x, y, z).init(phi_parameters::pair_wise_equation::phi_acc_number, phi_parameters::phi_number);
					}
			InputFileReader::get_instance()->read_bool_value("Solver.ControlEquation.Pairwise.NormalizePhi", phi_parameters::pair_wise_equation::is_phi_normalized, true);

			int difference_method = phi_parameters::pair_wise_equation::DifferenceMethod::FIVE_POINT;
			...
			phi_parameters::pair_wise_equation::diff_method = phi_parameters::pair_wise_equation::DifferenceMethod(difference_method);
			...
			phi_parameters::pair_wise_equation::grains_orientation.init(RotationGauge(rotation_gauge), phi_parameters::phi_number);
			...
			for (int i = 0; i < grains_value.size(); i++) {
				for (int j = 0; j < grains_value[i][0].size(); j++)
					phi_parameters::pair_wise_equation::grains_orientation.set_phi_orientation(grains_value[i][0][j].int_value,
			...
			if (InputFileReader::get_instance()->read_REAL_value("Solver.ControlEquation.Pairwise.Lij.const", phi_parameters::pair_wise_equation::const_Lij, true)) {
				mobility = Lij_pair_wise_const;
				intMob_type = 0;
				...
				if (InputFileReader::get_instance()->read_string_value(const_block_key, const_block_input, true)) {
					...
					for (int index = 0; index < const_block_value.size(); index++) {
						...
						phi_parameters::pair_wise_equation::const_block_Lij.push_back(const_block);
					}
				}
				...
				mobility = Lij_matrix;
				phi_parameters::pair_wise_equation::matirx_Lij.resize(phi_parameters::phi_number);
				for (int index = 0; index < phi_parameters::phi_number; index++)
					phi_parameters::pair_wise_equation::matirx_Lij[index].resize(phi_parameters::phi_number);
				intMob_type = 2;
				...
				for (int index = 0; index < matrix_value.size(); index++)
					phi_parameters::pair_wise_equation::matirx_Lij[matrix_value[index][0].int_value][matrix_value[index][1].int_value] = matrix_value[index][2].REAL_value;
			}
				...
				for (int index = 0; index < block_value.size(); index++) {
					phi_parameters::pair_wise_equation::block_Lij.push_back({ block_value[index][0].int_value, block_value[index][1].int_value });
					phi_parameters::pair_wise_equation::block_value_Lij.push_back(block_value[index][2].REAL_value);
				}
			}
			// - anisotropic
			...
			if (InputFileReader::get_instance()->read_string_value(matrix_aniso_key, matrix_aniso_input, true)) {
				...
				phi_parameters::pair_wise_equation::intMob_anisotropic_model_matrix.resize(phi_parameters::phi_property_number);
				phi_parameters::pair_wise_equation::intMobAniso1_matrix.resize(phi_parameters::phi_property_number);
				phi_parameters::pair_wise_equation::intMobAniso2_matrix.resize(phi_parameters::phi_property_number);
				phi_parameters::pair_wise_equation::intMobAniso3_matrix.resize(phi_parameters::phi_property_number);
				phi_parameters::pair_wise_equation::intMobAniso4_matrix.resize(phi_parameters::phi_property_number);
				for (int index = 0; index < phi_parameters::phi_property_number; index++) {
					phi_parameters::pair_wise_equation::intMob_anisotropic_model_matrix[index].resize(phi_parameters::phi_property_number);
					phi_parameters::pair_wise_equation::intMobAniso1_matrix[index].resize(phi_parameters::phi_property_number);
					phi_parameters::pair_wise_equation::intMobAniso2_matrix[index].resize(phi_parameters::phi_property_number);
					phi_parameters::pair_wise_equation::intMobAniso3_matrix[index].resize(phi_parameters::phi_property_number);
					phi_parameters::pair_wise_equation::intMobAniso4_matrix[index].resize(phi_parameters::phi_property_number);
				}
				...
				for (int index = 0; index < matrix_aniso_value.size(); index++) {
					...
					phi_parameters::pair_wise_equation::intMob_anisotropic_model_matrix[alpha_property][beta_property] = matrix_aniso_value[index][2].int_value;
					phi_parameters::pair_wise_equation::intMob_anisotropic_model_matrix[beta_property][alpha_property] = matrix_aniso_value[index][2].int_value;
					if (matrix_aniso_value[index][2].int_value == phi_parameters::pair_wise_equation::Int_Mobility_Anisotropic::IMA_CUBIC) {
						...
						phi_parameters::pair_wise_equation::intMobAniso1_matrix[alpha_property][beta_property] = aniso_par;
						phi_parameters::pair_wise_equation::intMobAniso1_matrix[beta_property][alpha_property] = aniso_par;
					}
					else if (matrix_aniso_value[index][2].int_value == phi_parameters::pair_wise_equation::Int_Mobility_Anisotropic::IMA_HEX_BOETTGER) {
						string matrix_aniso_par1 = "Solver.ControlEquation.Pairwise.Lij.Anisotropic." + matrix_aniso_value[index][0].string_value + "|" + matrix_aniso_value[index][1].string_value + ".parameter_1";
						REAL aniso_par = 0.0;
						InputFileReader::get_instance()->read_REAL_value(matrix_aniso_par1, aniso_par, true);
						phi_parameters::pair_wise_equation::intMobAniso1_matrix[alpha_property][beta_property] = aniso_par;
					...
					else if (matrix_aniso_value[index][2].int_value == phi_parameters::pair_wise_equation::Int_Mobility_Anisotropic::IMA_HEX_SUN) {
						string matrix_aniso_par1 = "Solver.ControlEquation.Pairwise.Lij.Anisotropic." + matrix_aniso_value[index][0].string_value + "|" + matrix_aniso_value[index][1].string_value + ".parameter_1";
						...
						phi_parameters::pair_wise_equation::intMobAniso2_matrix[alpha_property][beta_property] = aniso_par;
						phi_parameters::pair_wise_equation::intMobAniso2_matrix[beta_property][alpha_property] = aniso_par;
						InputFileReader::get_instance()->read_REAL_value(matrix_aniso_par3, aniso_par, true);
						phi_parameters::pair_wise_equation::intMobAniso3_matrix[alpha_property][beta_property] = aniso_par;
						phi_parameters::pair_wise_equation::intMobAniso3_matrix[beta_property][alpha_property] = aniso_par;
						InputFileReader::get_instance()->read_REAL_value(matrix_aniso_par4, aniso_par, true);
						phi_parameters::pair_wise_equation::intMobAniso4_matrix[alpha_property][beta_property] = aniso_par;
						phi_parameters::pair_wise_equation::intMobAniso4_matrix[beta_property][alpha_property] = aniso_par;
					}
					else if (matrix_aniso_value[index][2].int_value == phi_parameters::pair_wise_equation::Int_Mobility_Anisotropic::IMA_HEX_YANG) {
						string matrix_aniso_par1 = "Solver.ControlEquation.Pairwise.Lij.Anisotropic." + matrix_aniso_value[index][0].string_value + "|" + matrix_aniso_value[index][1].string_value + ".parameter_1";
						string matrix_aniso_par2 = "Solver.ControlEquation.Pairwise.Lij.Anisotropic." + matrix_aniso_value[index][0].string_value + "|" + matrix_aniso_value[index][1].string_value + ".parameter_2";
						string matrix_aniso_par3 = "Solver.ControlEquation.Pairwise.Lij.Anisotropic." + matrix_aniso_value[index][0].string_value + "|" + matrix_aniso_value[index][1].string_value + ".parameter_3";
						REAL aniso_par = 0.0;
			...
			InputFileReader::get_instance()->read_int_value("Solver.ControlEquation.Pairwise.InterfaceEnergy.int_gradient", phi_parameters::pair_wise_equation::interface_gradient, true);
			...
			InputFileReader::get_instance()->read_int_value("Solver.ControlEquation.Pairwise.InterfaceEnergy.int_potential", phi_parameters::pair_wise_equation::interface_potential, true);
			InputFileReader::get_instance()->read_REAL_value("Solver.ControlEquation.Pairwise.interface_width", phi_parameters::pair_wise_equation::interface_width, true);
			...
			if (InputFileReader::get_instance()->read_REAL_value("Solver.ControlEquation.Pairwise.xi_ab.const", phi_parameters::pair_wise_equation::const_xi_ab, true)) {
				_xi_ab = xi_ab_const;
				int_energy_type = 0;
			}
			else if (InputFileReader::get_instance()->read_string_value(matrix_key1, matrix_input1, true)) {
				_xi_ab = xi_ab_matrix;
				phi_parameters::pair_wise_equation::matirx_xi_ab.resize(phi_parameters::phi_property_number);
				for (int index = 0; index < phi_parameters::phi_property_number; index++)
					phi_parameters::pair_wise_equation::matirx_xi_ab[index].resize(phi_parameters::phi_property_number);
				int_energy_type = 1;
				...
				for (int index = 0; index < matrix_value.size(); index++) {
					...
					phi_parameters::pair_wise_equation::matirx_xi_ab[alpha_property][beta_property] = matrix_value[index][2].REAL_value;
				}
			}
			...
			if (InputFileReader::get_instance()->read_string_value(matrix_aniso_key2, matrix_aniso_input2, true)) {
				...
				phi_parameters::pair_wise_equation::intEn_anisotropic_model_matrix.resize(phi_parameters::phi_property_number);
				phi_parameters::pair_wise_equation::intEnAniso1_matrix.resize(phi_parameters::phi_property_number);
				phi_parameters::pair_wise_equation::intEnAniso2_matrix.resize(phi_parameters::phi_property_number);
				phi_parameters::pair_wise_equation::intEnAniso3_matrix.resize(phi_parameters::phi_property_number);
				phi_parameters::pair_wise_equation::intEnAniso4_matrix.resize(phi_parameters::phi_property_number);
				for (int index = 0; index < phi_parameters::phi_property_number; index++) {
					phi_parameters::pair_wise_equation::intEn_anisotropic_model_matrix[index].resize(phi_parameters::phi_property_number);
					phi_parameters::pair_wise_equation::intEnAniso1_matrix[index].resize(phi_parameters::phi_property_number);
					phi_parameters::pair_wise_equation::intEnAniso2_matrix[index].resize(phi_parameters::phi_property_number);
					phi_parameters::pair_wise_equation::intEnAniso3_matrix[index].resize(phi_parameters::phi_property_number);
					phi_parameters::pair_wise_equation::intEnAniso4_matrix[index].resize(phi_parameters::phi_property_number);
				}
				...
				for (int index = 0; index < matrix_aniso_value.size(); index++) {
					int alpha_property = materials_system::phi_property(matrix_aniso_value[index][0].string_value),
						beta_property = materials_system::phi_property(matrix_aniso_value[index][1].string_value);
					phi_parameters::pair_wise_equation::intEn_anisotropic_model_matrix[alpha_property][beta_property] = matrix_aniso_value[index][2].int_value;
					phi_parameters::pair_wise_equation::intEn_anisotropic_model_matrix[beta_property][alpha_property] = matrix_aniso_value[index][2].int_value;
					if (matrix_aniso_value[index][2].int_value == phi_parameters::pair_wise_equation::Int_Energy_Anisotropic::IEA_CUBIC) {
						...
						REAL aniso_par = 0.0;
						InputFileReader::get_instance()->read_REAL_value(matrix_aniso_par1, aniso_par, true);
						phi_parameters::pair_wise_equation::intEnAniso1_matrix[alpha_property][beta_property] = aniso_par;
						phi_parameters::pair_wise_equation::intEnAniso1_matrix[beta_property][alpha_property] = aniso_par;
					}
					else if (matrix_aniso_value[index][2].int_value == phi_parameters::pair_wise_equation::Int_Energy_Anisotropic::IEA_HEX_BOETTGER) {
						string matrix_aniso_par1 = "Solver.ControlEquation.Pairwise.xi_ab.Anisotropic." + matrix_aniso_value[index][0].string_value + "|" + matrix_aniso_value[index][1].string_value + ".parameter_1";
						REAL aniso_par = 0.0;
						InputFileReader::get_instance()->read_REAL_value(matrix_aniso_par1, aniso_par, true);
						phi_parameters::pair_wise_equation::intEnAniso1_matrix[alpha_property][beta_property] = aniso_par;
					...
					else if (matrix_aniso_value[index][2].int_value == phi_parameters::pair_wise_equation::Int_Energy_Anisotropic::IEA_HEX_SUN) {
						string matrix_aniso_par1 = "Solver.ControlEquation.Pairwise.xi_ab.Anisotropic." + matrix_aniso_value[index][0].string_value + "|" + matrix_aniso_value[index][1].string_value + ".parameter_1";
						...
						phi_parameters::pair_wise_equation::intEnAniso1_matrix[beta_property][alpha_property] = aniso_par;
						InputFileReader::get_instance()->read_REAL_value(matrix_aniso_par2, aniso_par, true);
						phi_parameters::pair_wise_equation::intEnAniso2_matrix[alpha_property][beta_property] = aniso_par;
						phi_parameters::pair_wise_equation::intEnAniso2_matrix[beta_property][alpha_property] = aniso_par;
						InputFileReader::get_instance()->read_REAL_value(matrix_aniso_par3, aniso_par, true);
						phi_parameters::pair_wise_equation::intEnAniso3_matrix[alpha_property][beta_property] = aniso_par;
						phi_parameters::pair_wise_equation::intEnAniso3_matrix[beta_property][alpha_property] = aniso_par;
						InputFileReader::get_instance()->read_REAL_value(matrix_aniso_par4, aniso_par, true);
						phi_parameters::pair_wise_equation::intEnAniso4_matrix[alpha_property][beta_property] = aniso_par;
						phi_parameters::pair_wise_equation::intEnAniso4_matrix[beta_property][alpha_property] = aniso_par;
					}
					else if (matrix_aniso_value[index][2].int_value == phi_parameters::pair_wise_equation::Int_Energy_Anisotropic::IEA_HEX_YANG) {
						string matrix_aniso_par1 = "Solver.ControlEquation.Pairwise.xi_ab.Anisotropic." + matrix_aniso_value[index][0].string_value + "|" + matrix_aniso_value[index][1].string_value + ".parameter_1";
						string matrix_aniso_par2 = "Solver.ControlEquation.Pairwise.xi_ab.Anisotropic." + matrix_aniso_value[index][0].string_value + "|" + matrix_aniso_value[index][1].string_value + ".parameter_2";
						string matrix_aniso_par3 = "Solver.ControlEquation.Pairwise.xi_ab.Anisotropic." + matrix_aniso_value[index][0].string_value + "|" + matrix_aniso_value[index][1].string_value + ".parameter_3";
						REAL aniso_par = 0.0;
			...
			if (InputFileReader::get_instance()->read_REAL_value("Solver.ControlEquation.Pairwise.xi_abc.const", phi_parameters::pair_wise_equation::const_xi_abc, true)) {
				_xi_abc = xi_abc_const;
			}
			else if (InputFileReader::get_instance()->read_string_value(matrix_key2, matrix_input2, true)) {
				_xi_abc = xi_abc_matrix;
				phi_parameters::pair_wise_equation::matirx_xi_abc.resize(phi_parameters::phi_property_number);
				for (int index1 = 0; index1 < phi_parameters::phi_property_number; index1++) {
					phi_parameters::pair_wise_equation::matirx_xi_abc[index1].resize(phi_parameters::phi_property_number);
					for (int index2 = 0; index2 < phi_parameters::phi_property_number; index2++)
						phi_parameters::pair_wise_equation::matirx_xi_abc[index1][index2].resize(phi_parameters::phi_property_number);
				}
				...
				for (int index = 0; index < matrix_value.size(); index++) {
					...
					phi_parameters::pair_wise_equation::matirx_xi_abc[alpha_property][beta_property][gamma_property] = matrix_value[index][3].REAL_value;
					phi_parameters::pair_wise_equation::matirx_xi_abc[alpha_property][gamma_property][beta_property] = matrix_value[index][3].REAL_value;
					phi_parameters::pair_wise_equation::matirx_xi_abc[beta_property][alpha_property][gamma_property] = matrix_value[index][3].REAL_value;
					phi_parameters::pair_wise_equation::matirx_xi_abc[beta_property][gamma_property][alpha_property] = matrix_value[index][3].REAL_value;
					phi_parameters::pair_wise_equation::matirx_xi_abc[gamma_property][alpha_property][beta_property] = matrix_value[index][3].REAL_value;
					phi_parameters::pair_wise_equation::matirx_xi_abc[gamma_property][beta_property][alpha_property] = matrix_value[index][3].REAL_value;
				}
			}

			// - multiple crack
			if (phi_parameters::pair_wise_equation::interface_gradient == phi_parameters::pair_wise_equation::Int_Gradient::DanielCrack_G2016 || phi_parameters::pair_wise_equation::interface_potential == phi_parameters::pair_wise_equation::Int_Potential::DanielCrack_P2016) {

				phi_parameters::pair_wise_equation::is_phi_normalized = true;
				phi_parameters::pair_wise_equation::phase_Gc.resize(phi_parameters::phi_property_number);

				string crack_name = "";
				if (InputFileReader::get_instance()->read_string_value("Solver.ControlEquation.Pairwise.crack_phi_name", crack_name, true))
					phi_parameters::pair_wise_equation::crack_phase_property = materials_system::phi_property(crack_name);

				InputFileReader::get_instance()->read_REAL_value("Solver.ControlEquation.Pairwise.crack_int_width", phi_parameters::pair_wise_equation::crack_int_width, true);

				InputFileReader::get_instance()->read_REAL_value("Solver.ControlEquation.Pairwise.crack_phi_cut_off", phi_parameters::pair_wise_equation::crack_num_cut_off, true);
				...
				if (InputFileReader::get_instance()->read_string_value(gc_key, gc_input, true)) {
					...
					for (int index = 0; index < gc_value.size(); index++)
						phi_parameters::pair_wise_equation::phase_Gc[materials_system::phi_property(gc_value[index][0].string_value)] = gc_value[index][1].REAL_value;
				}
			}
...
#pragma omp parallel for
			for (int x = phi_parameters::phase_field.X_BEGIN(); x <= phi_parameters::phase_field.X_END(); x++)
				for (int y = phi_parameters::phase_field.Y_BEGIN(); y <= phi_parameters::phase_field.Y_END(); y++)
					for (int z = phi_parameters::phase_field.Z_BEGIN(); z <= phi_parameters::phase_field.Z_END(); z++) {
						...
						phi_parameters::pair_wise_equation::PairwisePoint& point_ex = phi_parameters::pair_wise_equation::phase_field_pairwise(x, y, z);
		...
		inline void exec_i() {
			...
			phi_parameters::PHI_MAX_VARIATION = solve_phi_pair_wise();
			if (phi_parameters::pair_wise_equation::interface_gradient == phi_parameters::pair_wise_equation::Int_Gradient::DanielCrack_G2016
				|| phi_parameters::pair_wise_equation::interface_potential == phi_parameters::pair_wise_equation::Int_Potential::DanielCrack_P2016)
		...
		inline void deinit() {
			for (int x = 0; x < phi_parameters::pair_wise_equation::phase_field_pairwise.Nx(); x++)
				for (int y = 0; y < phi_parameters::pair_wise_equation::phase_field_pairwise.Ny(); y++)
					for (int z = 0; z < phi_parameters::pair_wise_equation::phase_field_pairwise.Nz(); z++) {
						phi_parameters::pair_wise_equation::phase_field_pairwise(x, y, z).clear();
					}
			phi_parameters::pair_wise_equation::phase_field_pairwise.clear();
			phi_parameters::pair_wise_equation::phase_field_Gc.clear();
		}
